...
/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/video.js */ "./js/modules/video.js");
...
/* harmony import */ var _modules_slider_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_slider_js__WEBPACK_IMPORTED_MODULE_2__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // ---------------------------------
  // iosVhFix();
  Object(_modules_video_js__WEBPACK_IMPORTED_MODULE_0__["initVideo"])();
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_1__["initTabs"])(); // Modules
  // ---------------------------------
...
var trainersSlider = new Swiper('#trainers-slider', {
  loop: true,
  breakpoints: {
    320: {
      slidesPerView: 1,
...
var buttons = subscriptions.querySelectorAll('.subscriptions__time-button');
var tabs = subscriptions.querySelectorAll('.subscriptions__list');
...
var initVideo = function initVideo() {
  var link = video.querySelector('.video__link'); // const media = video.querySelector('.video__media');
